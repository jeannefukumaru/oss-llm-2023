...
# mlflow_pd_test_data =<TODO: convert the Pandas DataFrame above to an mlflow.data object>
...
# TODO:
distilgpt2_pipe = pipeline("text-generation", model="") # FILL IN A MODEL NAME HERE

text = ""  # FILL IN SOME TEXT TO COMPLETE HERE
